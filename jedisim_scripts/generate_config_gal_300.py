...
color_infile="physics_settings/disk.txt"
#----------------------------database folders----------------------------------
...
config_path = r'physics_settings/gal_300.conf'
...
with open(config_path, 'a') as f:
    for i in range(num_source_images):
        line = r'image="simdatabase/gal_300_out/out{:d}.fits"'.format(i) + '\n'
        f.write(line)
