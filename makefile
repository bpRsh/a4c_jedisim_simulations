CC=gcc
CFLAGS=-O3 -Wall
LIBS=-I/usr/local/include -I/usr/include -I /Users/poudel/Applications/cfitsio/include  -L /Users/poudel/Applications/cfitsio/lib -I /Users/poudel/Applications/fftw3/include  -L /Users/poudel/Applications/fftw3/lib -lm -lcfitsio -lfftw3f
...
jedicatalog :
	gcc -Wall -O3 sources/jedicatalog.c -o executables/jedicatalog $(LIBS) -lm -lcfitsio -lfftw3f
