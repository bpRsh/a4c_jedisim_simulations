 ...
 *
 *
 * Compile     : gcc -Wall -O3 -o jediconvolve jediconvolve.c -lm -lcfitsio -lfftw3f
 *
 * Run         : ./jediconvolve out1/trial0_HST.fits psf/psf0.fits jedisim_out/out0/convolved/
 *                executable    fitsfile_to_convolve convolving_psf   empty_folder_to_write_6_bands
 *                                                               NOTE: give / at end
 *
...
char *help[] = {
    ...
    "usage: jediconvolve input_file PSF_file output_file",
    "Arguments: input_file - FITS file to convolve",
...
int main(int argc, char *argv[]){
    ...
    for(band = 0; band < num_bands; band++){
        ...
        fits_create_file(&outfptr, out1, &status);
