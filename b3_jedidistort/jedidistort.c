 ...
 * Run         : ./jedidistort 12288 12288 out1/trial0_dislist.txt physics_settings/lens.txt 0.03 0.3
 *                executable   nx    ny    dislist                 lens                      pix  redshift
 *
 *
 *
 * Depends     : 1. out1/trial0_dislist.txt
 *               2. physics_settings/lens.txt
 *               3. out1/stamp_0_to_12/stamp_0_to_999.fits.gz ( 12420 input zipped galaxies)
 *               4. out1/distorted_0_to_12/  ( 13 empty folder to write unzipped distorted galaxies)
 *
 *
 * Output      : 1. out1/distorted_0_to_12/
 *
 *
 ...
 * Usage       : ./executables/jedidistort 12288 12288 out1/trial0_dislist.txt
 *                physics_settings/lens.txt 0.03 0.3
 *
 *            executable   nx    ny    dislist     lens     pix  redshift
 *           ./jedidistort 12288 12288 dislist.txt lens.txt 0.03 0.3
 ...
 *
 *
 * Info        : This program distorts the 12420 galaxies from out1/stamp_0_to_stamp_12/fitsfiles
 *               according to dislist.txt and lens.txt and write distorted
 *               galaxies inside out1/distorted_/
 *
...
int main(int argc, char *argv[]){
        ...
        for(gal = 0; gal < ngalaxies; gal++){
                ...
                printf("it passed the if(naxes[0] != galaxies[gal].nx statement");
                ...
                printf("entering in the for loop\n");
                for(gr = ngr; gr > 0; gr--){
                ...
                //char x[100];
                //strcpy(x,"!");
                //strcat(x,galaxies[gal].outfile);
                printf("%s %li %s \n",galaxies[gal].outfile,gal,buf);
